        ...
        <Card className="shadow-lg hover:shadow-xl transition-all duration-300 group">
          <CardHeader className="pb-2">
            <div className="flex items-start">
              ...
              <div>
                <Badge variant="outline" className="mb-2 bg-primary/5 text-primary">Academic Partners</Badge>
                <CardTitle className="text-xl">Legal Research Institutions</CardTitle>
              </div>
            </div>
          </CardHeader>
          <CardContent>
        ...
        <Card className="shadow-lg hover:shadow-xl transition-all duration-300 group">
          <CardHeader className="pb-2">
            <div className="flex items-start">
              ...
              <div>
                <Badge variant="outline" className="mb-2 bg-primary/5 text-primary">Legal Partners</Badge>
                <CardTitle className="text-xl">Law Firms & Associations</CardTitle>
              </div>
            </div>
          </CardHeader>
          <CardContent>
        ...
        <Card className="shadow-lg hover:shadow-xl transition-all duration-300 group">
          <CardHeader className="pb-2">
            <div className="flex items-start">
              ...
              <div>
                <Badge variant="outline" className="mb-2 bg-primary/5 text-primary">Technical Partners</Badge>
                <CardTitle className="text-xl">Technology & AI Companies</CardTitle>
              </div>
            </div>
          </CardHeader>
          <CardContent>
        ...
        <Card className="shadow-lg hover:shadow-xl transition-all duration-300 group">
          <CardHeader className="pb-2">
            <div className="flex items-start">
              ...
              <div>
                <Badge variant="outline" className="mb-2 bg-primary/5 text-primary">Government Relations</Badge>
                <CardTitle className="text-xl">Regulatory & Compliance Partners</CardTitle>
              </div>
            </div>
          </CardHeader>
          <CardContent>
        ...
        <Card className="shadow-lg hover:shadow-xl transition-all duration-300 group">
          <CardHeader className="pb-2">
            <div className="flex items-start">
              ...
              <div>
                <Badge variant="outline" className="mb-2 bg-primary/5 text-primary">Community Partners</Badge>
                <CardTitle className="text-xl">Public Interest & Access to Justice</CardTitle>
              </div>
            </div>
          </CardHeader>
          <CardContent>
